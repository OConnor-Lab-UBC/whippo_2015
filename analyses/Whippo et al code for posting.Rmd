...
kable(RanksMay, col.names = c("Species", "DC", "WI", "RP","NB", "CB"), caption = "Ranks for May species abundances (N)")
...
kable(RanksAug, col.names = c("Species", "DC", "WI", "RP","NB", "CB"), caption = "Ranks for Aug species abundances (N)")
```
